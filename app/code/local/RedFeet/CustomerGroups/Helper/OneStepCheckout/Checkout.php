<?php
class RedFeet_CustomerGroups_Helper_OneStepCheckout_Checkout extends Idev_OneStepCheckout_Helper_Checkout
{
        ...
        if($data['group_id'] == 2){
            ...
            foreach($firstname as $surname){
                if($cont > 0){
                    ...
                    $firstname_shipping = $surname;
                }
                $cont++;
            }
            $data['firstname'] = $firstname_shipping;
