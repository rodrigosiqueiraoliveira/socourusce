 ...
 */
class RedFeet_CustomerGroups_Model_Checkout_Type_Onepage
{
    /**
    ...
    public function saveBilling($data, $customerAddressId)
    {
        ...
        if (!empty($customerAddressId)) {
            ...
            if($data['group_id'] == 2){
                ...
                $addressData['firstname'] = $firstname_billing;
    ...
    protected function _prepareNewCustomerQuote()
    {
        ...
        if($customer_data['group_id'] == 2){
            $customerBilling->setFirstname($billing_data['firstname']);
            $customerBilling->setLastname($billing_data['lastname']);
        }
        ...
        if ($shipping && !$shipping->getSameAsBilling()) {
            ...
            if($customer_data['group_id'] == 2){
                $customerShipping->setFirstname($billing_data['firstname']);
                $customerShipping->setLastname($billing_data['lastname']);
            }
        ...
        /*Verifica se usuário atacadista.*/
        if($customer_data['group_id'] == 2){
            $customer->setFirstname($billing_data['firstname']);
            $customer->setLastname($billing_data['lastname']);
        }
