        ...
        if ($this->getRequest()->isPost()) {
            ...
            */
            ...
            if($this->getRequest()->getPost('group_id') == $cgAtacado){
                ...
                /*$nomeCompleto = explode (' ', $this->getRequest()->getPost('nome_fantasia'));
                
                $sobrenome = "";
                
                foreach ($nomeCompleto as $key => $nome) {
                ...
                $customerData['firstname'] = $nomeCompleto[0];
                if($sobrenome == ""){
                    $customerData['lastname'] = $nomeCompleto[0];
                }else{
                    $customerData['lastname'] = $sobrenome;
                }*/
