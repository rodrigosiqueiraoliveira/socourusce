...
class RedFeet_CustomerGroups_AccountController extends Mage_Customer_AccountController
{
    /**
    ...
    public function createPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            /*Verifica se usuário atacadista.*/
            if($this->getRequest()->getPost('group_id') == $cgAtacado){
                /*Alterando campos firstname e lastname*/
                $firstname = explode (' ', $this->getRequest()->getPost('firstname'));
                
                $cont = 0;
                foreach($firstname as $surname){
                    if($cont > 0){
                        $lastname .= $surname." ";    
                    }else{
                        $firstname = $surname;
            ...
            if ($this->getRequest()->getPost('create_address')) {
                ...
                /*Valida se for usuário atacadista, para eliminar erros de campos obrigatórios originais do magento*/
                if($this->getRequest()->getPost('group_id') != $cgAtacado){
                ...
                /*Tratamento de campos firstname e lastname para usuário atacadista para o cadastro de endereço*/
                if($this->getRequest()->getPost('group_id') == $cgAtacado){
                ...
                if ($addressErrors === true) {
                    ...
                    /*Cria endereço para usuário atacadista*/
                    $address->setId(null)
            ...
            try {
                /*Validar se grupo é atacado e processar sem campos obrigatórios padrão*/
                if($this->getRequest()->getPost('group_id') == $cgAtacado){

                    /*Tratamento de campos firstname e lastname para usuário atacadista*/
                    $customerData['firstname'] = $firstname;
                    $customerData['lastname'] = $lastname;
                    $customer->setFirstname($firstname);
                    $customer->setLastname($lastname);

                    /*Adicionando campos para usuário atacadista*/
                    $customer->setRazaoSocial($this->getRequest()->getPost('razao_social'));
                    $customer->setInscricaoEstadual($this->getRequest()->getPost('inscricao_estadual'));
                    $customer->setIsento($this->getRequest()->getPost('isento'));
                    $customer->setNomeFantasia($this->getRequest()->getPost('nome_fantasia'));
                    /*Fim*/
                ...
                /*Set RG for customer*/
                $customer->setRg($this->getRequest()->getPost('rg'));
    ...
    public function editPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $customer_data = Mage::helper('customer')->getCustomer()->getData();

            if($customer_data['group_id'] != $cgAtacado){
                $customerErrors = $customerForm->validateData($customerData);
            }else{
            ...
            try {
                /*Adicionando campos para usário atacadista*/
                if($customer_data['group_id'] == $cgAtacado){
                    /*Alterando campos firstname e lastname*/
                    $firstname = explode (' ', $this->getRequest()->getPost('firstname'));
                    ...
                    $customer->setTaxvat($this->getRequest()->getPost('taxvat'));
                    $customer->setRazaoSocial($this->getRequest()->getPost('razao_social'));
                    $customer->setInscricaoEstadual($this->getRequest()->getPost('inscricao_estadual'));
                    $customer->setIsento($this->getRequest()->getPost('isento'));
                    $customer->setNomeFantasia($this->getRequest()->getPost('nome_fantasia'));
