 ...
 */
class Madia_Adyen_Helper_Data extends Mage_Payment_Helper_Data {

    public function getCcTypes() {
        $_types = Mage::getConfig()->getNode('default/madia/adyen/cctypes')->asArray();
    ...
    public function getHppTypes() {
        $_types = Mage::getConfig()->getNode('default/madia/adyen/hpptypes')->asArray();
        $types = array();
        foreach ($_types as $data) {
            $types[$data['code']] = $data['name'];
        }
