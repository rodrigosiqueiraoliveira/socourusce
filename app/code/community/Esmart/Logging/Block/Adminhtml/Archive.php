 ...
 *
 */
class Esmart_Logging_Block_Adminhtml_Archive extends Mage_Adminhtml_Block_Widget_Container
{
    /**
     * Header text getter
     *
    ...
    {
        return Mage::helper('esmart_logging')->__('Admin Actions Log Archive');
    }
