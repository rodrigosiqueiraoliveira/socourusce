 ...
 *
 * @method Esmart_Logging_Model_Resource_Event_Changes _getResource()
 * @method Esmart_Logging_Model_Resource_Event_Changes getResource()
 * @method string getSourceName()
 * @method Esmart_Logging_Model_Event_Changes setSourceName(string $value)
 * @method int getEventId()
 * @method Esmart_Logging_Model_Event_Changes setEventId(int $value)
 * @method int getSourceId()
 * @method Esmart_Logging_Model_Event_Changes setSourceId(int $value)
 * @method string getOriginalData()
 * @method Esmart_Logging_Model_Event_Changes setOriginalData(string $value)
 * @method string getResultData()
 * @method Esmart_Logging_Model_Event_Changes setResultData(string $value)
 *
 */
class Esmart_Logging_Model_Event_Changes extends Mage_Core_Model_Abstract
{
    /**
     * Config path to fields that must be not be logged for all models
     *
     */
    const XML_PATH_SKIP_GLOBAL_FIELDS = 'adminhtml/esmart/logging/skip_fields';
    ...
    protected function _construct()
    {
        ...
        $this->_init('esmart_logging/event_changes');
    }
