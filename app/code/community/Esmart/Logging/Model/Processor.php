...
class Esmart_Logging_Model_Processor
{
    /**
    ...
    /**
     * Temporary storage for model changes before saving to esmart_logging_event_changes table.
     *
     * @var array
     */
    ...
    {
        $this->_config = Mage::getSingleton('esmart_logging/config');
        $this->_modelsHandler = Mage::getModel('esmart_logging/handler_models');
        $this->_controllerActionsHandler = Mage::getModel('esmart_logging/handler_controllers');
    }
    ...
    public function logAction()
    {
        ...
        $loggingEvent = Mage::getModel('esmart_logging/event')->setData(array(
        ...
        if ($this->_actionName == 'denied') {
            ...
            $loggingEvent->setInfo(Mage::helper('esmart_logging')->__('Access denied'));
     ...
     *
     * @param Esmart_Logging_Model_Event_Changes $eventChange
     * @return Esmart_Logging_Model_Processor
     */
