 ...
 */
  ...
  */
class Esmart_Logging_Model_Source_Frequency
{
    public function toOptionArray()
    {
        return array(
            array(
                'value' => 1,
                'label' => Mage::helper('esmart_logging')->__('Daily')
            ),
            array(
                'value' => 7,
                'label' => Mage::helper('esmart_logging')->__('Weekly')
            ),
            array(
                'value' => 30,
                'label' => Mage::helper('esmart_logging')->__('Monthly')
            ),
        );
    }
}
