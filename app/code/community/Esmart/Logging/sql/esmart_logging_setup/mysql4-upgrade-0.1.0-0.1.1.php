...
$installer->run("DROP TABLE IF EXISTS `{$this->getTable('esmart_logging_user_log')}`");
$installer->getConnection()->addColumn($this->getTable('esmart_logging/event'), 'status', "char(15) NOT NULL DEFAULT 'success'");
