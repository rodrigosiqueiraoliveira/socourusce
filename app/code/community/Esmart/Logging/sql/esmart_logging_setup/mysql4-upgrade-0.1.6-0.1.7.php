...
$installer->run("DELETE FROM {$installer->getTable('core_config_data')} WHERE `path` LIKE 'admin/esmart_logging/%'");
$installer->getConnection()->changeColumn($installer->getTable('esmart_logging/event'),
