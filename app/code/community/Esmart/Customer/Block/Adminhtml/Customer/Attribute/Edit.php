...
class Esmart_Customer_Block_Adminhtml_Customer_Attribute_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function getHeaderText()
    {
        if ($this->_getAttribute()->getId()) {
            ...
            return Mage::helper('esmart_customer')->__('Edit Customer Attribute "%s"', $label);
        } else {
            return Mage::helper('esmart_customer')->__('New Customer Attribute');
        }
    }
