...
class Esmart_Customer_Block_Adminhtml_Customer_Address_Attribute_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('esmart_customer')->__('Save Attribute'));
        if (!$this->_getAttribute()->getIsUserDefined()) {
            $this->_removeButton('delete');
        } else {
            $this->_updateButton('delete', 'label', Mage::helper('esmart_customer')->__('Delete Attribute'));
        }
    }
    ...
    public function getHeaderText()
    {
        if ($this->_getAttribute()->getId()) {
            ...
            return Mage::helper('esmart_customer')->__('Edit Customer Address Attribute "%s"', $label);
        } else {
            return Mage::helper('esmart_customer')->__('New Customer Address Attribute');
        }
    }
