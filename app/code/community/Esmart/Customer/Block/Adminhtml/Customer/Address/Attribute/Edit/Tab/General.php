...
class Esmart_Customer_Block_Adminhtml_Customer_Address_Attribute_Edit_Tab_General
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
     ...
     *
     * @return Esmart_Customer_Block_Adminhtml_Customer_Address_Attribute_Edit_Tab_General
     */
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent('esmart_customer_address_attribute_edit_tab_general_prepare_form', array(
            'form'      => $form,
            'attribute' => $attribute
        ));
