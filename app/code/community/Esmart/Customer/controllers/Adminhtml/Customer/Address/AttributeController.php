...
class Esmart_Customer_Adminhtml_Customer_Address_AttributeController extends Mage_Adminhtml_Controller_Action
{
    /**
     ...
     *
     * @return Esmart_Customer_Adminhtml_Customer_Address_AttributeController
     */
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_addBreadcrumb(
                Mage::helper('esmart_customer')->__('Customer'),
                Mage::helper('esmart_customer')->__('Customer'))
            ->_addBreadcrumb(
                Mage::helper('esmart_customer')->__('Manage Customer Address Attributes'),
                Mage::helper('esmart_customer')->__('Manage Customer Address Attributes'));
        return $this;
    }
    ...
    public function editAction()
    {
        ...
        if ($attributeId) {
            ...
            if (!$attributeObject->getId()) {
                $this->_getSession()->addError(
                    Mage::helper('esmart_customer')->__('Attribute is no longer exists.')
                );
                $this->_redirect('*/*/');
                return;
            }
            if ($attributeObject->getEntityTypeId() != $this->_getEntityType()->getId()) {
                $this->_getSession()->addError(
                    Mage::helper('esmart_customer')->__('You cannot edit this attribute.')
                );
                $this->_redirect('*/*/');
                return;
            }
        ...
        $label = $attributeObject->getId()
            ? Mage::helper('esmart_customer')->__('Edit Customer Address Attribute')
            : Mage::helper('esmart_customer')->__('New Customer Address Attribute');
    ...
    public function validateAction()
    {
        ...
        if (!$attributeId) {
            ...
            if ($attributeObject->getId()) {
                $this->_getSession()->addError(
                    Mage::helper('esmart_customer')->__('Attribute with the same code already exists')
                );
    ...
    {
        return Mage::helper('esmart_customer/address')->filterPostData($data);
    }
    ...
    public function saveAction()
    {
        ...
        if ($this->getRequest()->isPost() && $data) {
            ...
            try {
                ...
                Mage::dispatchEvent('esmart_customer_address_attribute_save', array(
                    'attribute' => $attributeObject
                ));

                $this->_getSession()->addSuccess(
                    Mage::helper('esmart_customer')->__('The customer address attribute has been saved.')
                );
                ...
                $this->_getSession()->addException($e,
                    Mage::helper('esmart_customer')->__('An error occurred while saving the customer address attribute.')
                );
                $this->_getSession()->setAttributeData($data);
                $this->_redirect('*/*/edit', array('_current' => true));
                return;
    ...
    public function deleteAction()
    {
        ...
        if ($attributeId) {
            ...
            {
                $this->_getSession()->addError(
                    Mage::helper('esmart_customer')->__('You cannot delete this attribute.')
                );
                $this->_redirect('*/*/');
                return;
            }
            try {
                ...
                Mage::dispatchEvent('esmart_customer_address_attribute_delete', array(
                    'attribute' => $attributeObject
                ));
                $this->_getSession()->addSuccess(
                    Mage::helper('esmart_customer')->__('The customer address attribute has been deleted.')
                );
                $this->_redirect('*/*/');
                return;
            } catch (Mage_Core_Exception $e) {
                ...
                $this->_getSession()->addException($e,
                    Mage::helper('esmart_customer')->__('An error occurred while deleting the customer address attribute.')
                );
                $this->_redirect('*/*/edit', array('attribute_id' => $attributeId, '_current' => true));
                return;
            }
