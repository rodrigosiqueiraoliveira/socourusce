...
abstract class Esmart_Customer_Model_Resource_Sales_Abstract extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     ...
     *
     * @param Mage_Customer_Model_Attribute $attribute
     * @return Esmart_Customer_Model_Resource_Sales_Abstract
     */
     ...
     *
     * @param Esmart_Customer_Model_Sales_Abstract $sales
     * @return bool
     */
    public function isEntityExists(Esmart_Customer_Model_Sales_Abstract $sales)
    {
        if (!$sales->getId()) {
            return false;
        }
