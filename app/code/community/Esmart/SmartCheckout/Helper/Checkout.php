 ...
 */
class Esmart_SmartCheckout_Helper_Checkout extends Mage_Core_Helper_Abstract
{
    ...
    function __construct()
    {
        ...
        $this->temp = Mage::getStoreConfig('smartcheckout/general/' . base64_decode('c2VyaWFs'));
    }
    ...
    public function loadConfig()
    {
        ...
        foreach($items as $config)    {
            ...
            $settings[$name] = Mage::getStoreConfig('smartcheckout/' . $config);
        }
