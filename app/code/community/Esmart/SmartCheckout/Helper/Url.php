 ...
 */
class Esmart_SmartCheckout_Helper_Url extends Mage_Checkout_Helper_Url
{
    /**
    ...
    {
        if (!Mage::helper('smartcheckout')->isRewriteCheckoutLinksEnabled()){
            return parent::getCheckoutUrl();
        }
        return $this->_getUrl('smartcheckout', array('_secure'=>true));
    }
}