 ...
 */
class Esmart_SmartCheckout_Model_Observers_SortFields extends Mage_Core_Model_Abstract
{
    ...
    public function applyFieldOrder(Varien_Event_Observer $observer) {
        ...
        //config varialbes
        $sort = Mage::getStoreConfig('smartcheckout/sortordering_fields');
        $whitelist = $this->getWhiteList(Mage::getStoreConfig('smartcheckout/exclude_fields'));
